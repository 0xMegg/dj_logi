    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2 text-gray-700">
            <li>
              본 약관은 사이트 화면에 게시하거나 기타의 방법으로 이용자에게
              공지함으로써 효력이 발생합니다.
            </li>
            <li>
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2 text-gray-700">
            <li>
              사이트 이용은 회사의 업무상 또는 기술상 특별한 지장이 없는 한
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2 text-gray-700">
            ...
            <li>
              사이트가 정한 정보 이외의 정보(컴퓨터 프로그램 등) 등의 송신 또는
              게시
            </li>
        ...
        <section>
          <h2 className="text-xl font-semibold mb-4">제7조 (책임제한)</h2>
          <ul className="list-disc pl-5 space-y-2 text-gray-700">
            <li>
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2 text-gray-700">
            ...
            <li>
              이용자는 사이트를 이용함으로써 얻은 정보를 회사의 사전 승낙 없이
